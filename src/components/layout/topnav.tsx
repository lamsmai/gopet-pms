...
const MENUS: Menu[] = [
  ...
  },
  {
    ...
    cols: [
      {
        header: { key: "nav.comms" },
        items: [
          { to: "/communications/zalo", key: "nav.comm.zalo", icon: MessageSquare },
          { to: "/communications/sms", key: "nav.comm.sms", icon: MessageSquareText },
          { to: "/communications/email", key: "nav.comm.email", icon: Mail },
          ...
          { to: "/communications/bulk-send", key: "nav.comm.bulk", icon: Send, phase2: true },
        ],
      },
